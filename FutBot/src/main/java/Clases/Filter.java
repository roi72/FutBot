...
public class Filter {
    ...
    public static ArrayList<Result> filtrarInfo(String nombreEquipo1, String nombreEquipo2, String partido, String elementosAFiltrar, int ronda){
        ...
        for (int i = 0 ; i <= 5 ; i++) {
            System.out.println(datosEquipo1[i] + " " + datosEquipo2[i]);
        }
        ArrayList<Result> listaEquipos = new ArrayList<>();

        Result resultado1 = new Result(nombreEquipo1, partido, ronda, posesionEquipo1, golesEquipo1, cornersEquipo1, fuerasDeJuegoEquipo1, pasesEnProfundidadEquipo1,
                ocasionesEquipo1, tirosTotalesEquipo1, tirosPuerta1, tirosPalo1, tirosFuera1, tirosBloqueados1, entradas1, faltas1,
                tarjetasAmarillas1);
        Result resultado2 = new Result(nombreEquipo2, partido, ronda, posesionEquipo2, golesEquipo2, cornersEquipo2, fuerasDeJuegoEquipo2, pasesEnProfundidadEquipo2,
                ocasionesEquipo2, tirosTotalesEquipo2, tirosPuerta2, tirosPalo2, tirosFuera2, tirosBloqueados2, entradas2, faltas2,
                tarjetasAmarillas2);
